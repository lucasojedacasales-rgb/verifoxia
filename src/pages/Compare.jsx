...
export default function Compare() {
  ...
  useSEO({
    ...
    description: "Compara dos productos cara a cara con IA. Precios, especificaciones técnicas, valoraciones y veredicto final.",
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 pb-24">
        ...
        {loading && (
          <div className="flex flex-col items-center py-24 gap-4">
            ...
            <p className="text-slate-500 text-sm">Generando comparativa con IA</p>
          </div>
        )}
